// refer to https://github.com/gorilla/websocket/blob/master/examples/chat/client.go for code origination
...
// Client struct to manage messages sent to client and recieved from client
